...
function initDatatables(url, orderFalse, drawCallback = "") {
...
$("#external_search").on("keyup", function () {
    $("#DataTables_Table_0_filter").find("input").val($(this).val());
    $("#DataTables_Table_0_filter").find("input").trigger("keyup");
});

$("#external_length").on("change", function () {
    $("[name='DataTables_Table_0_length']").val($(this).val());
    $("[name='DataTables_Table_0_length']").trigger("change");
});
